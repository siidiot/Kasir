            ...
            <div class="row-fluid">
                ...
                <div class="span10" id="content">
                    ...
                    <?php if($this->session->flashdata('sukses')): ?>
                     ...
                     <div class="well">
                        <!-- block -->
                        <?=form_open('laporan/penjualan', ['class'=>'form-horizontal'],'novalidate');?>
                        <table class="table table-bordered">
                            <tr class="alert alert-warning">
                                <th colspan="4">Periode Penjualan</th>
                            </tr>
                            <tr>
                                         ...
                                         <ul class="dropdown-menu">
                                          ...
                                          ?>
                                           <?php if(!empty($tgl1 AND $bar)):?>
                                            <li><?=anchor('laporan/cetak_semua_penjualan/'.$tgl1.'/'.$tgl2.'/'.$bar, 'Cetak PDF', ['target'=>'_blank']);?></li>
                                        <?php elseif(!empty($tgl1)):?>
                                            <li><?=anchor('laporan/cetak_semua_penjualan/'.$tgl1.'/'.$tgl2, 'Cetak PDF', ['target'=>'_blank']);?></li>
                                        <?php elseif(!empty($barang)):?>
                                            <li><?=anchor('laporan/cetak_semua_penjualan/'.$bar, 'Cetak PDF', ['target'=>'_blank']);?></li>
                                        <?php else:?>
                                             <li><?=anchor('laporan/cetak_semua_penjualan', 'Cetak PDF', ['target'=>'_blank']);?></li>
                                        <?php endif?>
                                         </ul>
                                      </div>
                                   </div>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><p align="center">Harga Item</th>
                                        ...
                                        <tbody>
                                           <?php 
                                            ...
                                            <tr>
                                                 ...
                                                 <td><p align="center">Rp. <?=number_format($s->harga,0,",",".")?></td>
